var s_tc_ArsTechnica=new TagContainer('ArsTechnica');
...
s_tc_ArsTechnica.cl=[{p:[{t:'s',u:'//js.revsci.net/gateway/gw.js?csid=F09828&auto=t&bpid=condenast'}]}];
s_tc_ArsTechnica.cr();